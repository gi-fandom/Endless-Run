...
- (void)application:(UIApplication *)application willChangeStatusBarOrientation:(UIInterfaceOrientation)newStatusBarOrientation duration:(NSTimeInterval)duration {
    if ([super respondsToSelector: @selector(application:willChangeStatusBarOrientation:duration:)]) {
...
- (void)application:(UIApplication *)application didChangeStatusBarOrientation:(UIInterfaceOrientation)oldStatusBarOrientation {
    if ([super respondsToSelector: @selector(application:didChangeStatusBarOrientation:)]) {
...
- (void)application:(UIApplication *)application willChangeStatusBarFrame:(CGRect)newStatusBarFrame {
    if ([super respondsToSelector: @selector(application: willChangeStatusBarFrame:)]) {
...
- (void)application:(UIApplication *)application didChangeStatusBarFrame:(CGRect)oldStatusBarFrame {
    if ([super respondsToSelector: @selector(application: didChangeStatusBarFrame:)]) {
...
- (void)applicationDidReceiveMemoryWarning:(UIApplication *)application {
    if ([super respondsToSelector: @selector( applicationDidReceiveMemoryWarning:)]) {
...
- (void)applicationSignificantTimeChange:(UIApplication *)application {
    if ([super respondsToSelector: @selector(applicationSignificantTimeChange:)]) {
...
- (void)applicationProtectedDataWillBecomeUnavailable:(UIApplication *)application {
    if ([super respondsToSelector: @selector(applicationProtectedDataWillBecomeUnavailable:)]) {
